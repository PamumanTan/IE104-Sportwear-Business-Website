...
<body>
    ...
    <div class="main">
        <div class="container">
            <form action="../productController.php" method="POST" value='create' enctype="multipart/form-data">
                <h2>Thêm sản phẩm</h2>
                <br>
                ...
                <div>
                    ...
                    <input class="form-control" type="text" id="productImage" name="productImage" placeholder="Link ảnh sản phẩm">
                </div>
                <button>
                    Lưu
                </button>
